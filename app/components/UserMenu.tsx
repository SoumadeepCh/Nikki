    ...
    return (
        <div className="relative z-50" ref={menuRef}>
            <button
                ...
                className="w-10 h-10 rounded-full bg-violet-600 flex items-center justify-center text-white font-semibold text-lg hover:bg-violet-500 transition-colors shadow-lg border border-white/10"
            >
                {initial}
            </button>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute right-0 mt-2 w-64 origin-top-right glass rounded-xl border border-white/10 shadow-2xl overflow-hidden"
                    >
